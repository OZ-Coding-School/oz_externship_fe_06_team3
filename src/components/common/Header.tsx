              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {open && (
                  <div className="absolute top-17 right-0 z-50 w-[204px] rounded-[12px] bg-white px-[16px] py-[16px] shadow-[0_0_16px_0_#A0A0A040]">
                    ...
                    <div className="border-mono-200 my-4 border-t" />

                    <Button
                      type="button"
                      variant="link"
                      size="auto"
                      className="hover:bg-primary-100 hover:text-primary block w-full justify-start py-3 text-left text-sm hover:no-underline"
                      onClick={() => {
                        setOpen(false)
                        navigate('/register')
                      }}
